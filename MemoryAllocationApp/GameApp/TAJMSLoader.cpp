...
{
    // Does not support sub directory
    printf("TAJMS format does not support sub directory!");
    LoadFile(p_fileName);
}
...
void TAJMSLoader::LoadResource(GUID p_GUID, const std::string & p_directory)
{
    ParserAndContainerManager& t_parAndContMan = ParserAndContainerManager::Get();
    FILE* t_file;
    fopen_s(&t_file, p_directory.c_str(), "rb");
...
void TAJMSLoader::LoadResource(GUID p_GUID, const std::string & p_fileEnding, const std::string & p_directory)
{
    ParserAndContainerManager& t_parAndContMan = ParserAndContainerManager::Get();
    FILE* t_file;
    fopen_s(&t_file, p_directory.c_str(), "rb");
